...
import (
	...
	"github.com/openshift/reference-addon/internal/addoninstancesdk/clientgosdk"
...
var _ clientgosdk.AddonInstanceInteractorClient = (*ReferenceAddonInteractor)(nil)
...
func (r ReferenceAddonInteractor) UpdateAddonInstanceStatus(ctx context.Context, addonInstance *addonsv1alpha1.AddonInstance, condition metav1.Condition) error {
...
func (r ReferenceAddonInteractor) AddonInstanceSpecChangeWatcher() (chan bool, error) {
	// effectively, no addoninstance watcher is set here
